...
class Features extends Component
{
    ...
    #[Title('لوحة التحكم - المميزات'), Layout('layouts.admin.app')]
    public function render()
    {
        ...
        $features = $service->data($this->filters, $this->sort_field, $this->sort_direction, $this->pagination);
        $this->resetPage();
    ...
    {
        return Services::createInstance("FeatureService") ?? new Services();
    }
    ...
    public function updateFeature()
    {
        ...
        $rules = $service->rules($this->feature_id);
        $messages = $service->messages();
        $validator = Validator::make($data, $rules, $messages);
        $errors = array_map(fn ($value) => $value[0], $validator->errors()->toArray());
        ...
        $result = $service->update($data, $this->feature_id);

<div class="container-fluid">
    <div class="p-4 mb-4">
        ...
        <div class="row mb-4" wire:ignore>
            ...
            <!-- Page Title  -->
            <h2 style="font-weight: bold;">الشركاء</h2>
            <!-- Page Title  -->
                ...
                <div class="container-fluid">
                    ...
                    <nav aria-label="breadcrumb">
                        <ol class="breadcrumb" style="font-weight: bold;">
                            ...
                            <li class="breadcrumb-item"><a href="#">إدارة الشركاء</a></li>
                            ...
                            <ul class="dropdown-menu dropdown-menu-end" aria-labelledby="navbarDropdownMenuLink">
                                ...
                                <li>
                                    <a class="dropdown-item" data-mdb-toggle="modal"
                                        data-mdb-target="#create-new-partner-modal" href="#create-new-partner-modal">
                ...
                <tbody>
                    @foreach ($partners as $partner)
                        <tr>
                            ...
                            <td>
                                <div class="lightbox">
                                    <img src="{{ $partner->photo_table }}" data-mdb-img="{{ $partner->photo_table }}"
                                        width="30" height="30">
                                </div>
                            </td>
                            <td class="switch">
                                <label>
                                    نشط
                                    <input wire:click="changeStatus({{ $partner->id }})" type="checkbox"
                            ...
                            <td>
                                <div class="d-flex justify-content-center">
                                    <a type="button" class="text-danger fa-lg me-2 ms-2"
                                        wire:click='delete({{ $partner->id }})' title="Delete">
                                        <i class="fas fa-trash-can"></i>
                                    </a>

                                    <a type="button" class="text-dark fa-lg me-2 ms-2 set-button-update"
                                        data-mdb-toggle="modal" data-mdb-target="#create-new-partner-modal"
                                        href="#create-new-partner-modal" title="Editpartner"
        ...
        <div class="d-flex justify-content-between">
            ...
            <nav aria-label="...">
                <ul class="pagination pagination-circle">
                    {{ $partners->withQueryString()->onEachSide(0)->links() }}
                </ul>
            </nav>
    ...
    <div class="modal top fade" id="create-new-partner-modal" tabindex="-1" data-mdb-backdrop="static"
        ...
        <div class="modal-dialog cascading-modal" style="margin-top: 5%">
            <div class="modal-content">
                <div class="modal-c-tabs">
                    ...
                    <!-- Tabs navs -->
                    <ul class="nav md-tabs nav-tabs" id="create-new-partner" role="tablist"
                        style="background-color: #303030;">
                        <li class="nav-item" role="presentation">
                            <a data-mdb-tab-init class="nav-link active" id="create-new-partner-tab-1"
                                href="#create-new-partner-tabs-1" role="tab"
                                aria-controls="create-new-partner-tabs-1" aria-selected="true">
                    ...
                    <div class="tab-content" id="ex1-content">
                        ...
                        <div class="tab-pane fade show active" id="create-new-partner-tabs-1" role="tabpanel"
                            aria-labelledby="create-new-partner-tab-1">

                            <div class="modal-body">

                                <div class="row mb-3">
                                    <div class="col-md-12">
                                        <x-file-input label="صورة" model="partner"
                            ...
                            <div class="modal-footer">
                                ...
                                <button type="button" class="btn text-white blue-color create-button"
                                    wire:click='addPartner()'>حفظ</button>

                                <button type="button" class="btn text-white blue-color update-button"
                                    wire:click='updatePartner()'>تحديث</button>
...
@push('create-new-partner-script')
    <script>
        $(document).ready(function() {
            ...
            Livewire.on("process-has-been-done", function() {
                ...
                $("#create-new-partner-modal").modal('hide');
                $(".create-button").show();
                $(".update-button").hide();
            });

            Livewire.on("create-new-partner-errors", function(errors) {
                $(".reset-validation").text("");
                for (let key in errors[0]) {
                    if (errors[0].hasOwnProperty(key)) {
                        $("." + key + "-partner-validation").text(errors[0][key]);
                    }
                }
            });

            Livewire.on("set-partner-status", function(data) {
                const singleSelect = document.querySelector("#add-partner-status");

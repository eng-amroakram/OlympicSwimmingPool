<div class="container-fluid">
    <div class="p-4 mb-4">
        ...
        <div class="row mb-4" wire:ignore>
            ...
            <!-- Page Title  -->
            <h2 style="font-weight: bold;">السلايدرز</h2>
            <!-- Page Title  -->
                ...
                <div class="container-fluid">
                    ...
                    <nav aria-label="breadcrumb">
                        <ol class="breadcrumb" style="font-weight: bold;">
                            ...
                            <li class="breadcrumb-item"><a href="#">إدارة قسم السلايدرز</a></li>
                            <li class="breadcrumb-item active"><a href="#">السلايدرز</a>
                            </li>
                        </ol>
                    </nav>
                            ...
                            <ul class="dropdown-menu dropdown-menu-end" aria-labelledby="navbarDropdownMenuLink">
                                ...
                                <li>
                                    <a class="dropdown-item" data-mdb-toggle="modal"
                                        data-mdb-target="#create-new-slider-modal" href="#create-new-slider-modal">
            ...
            <table class="table table-bordered text-center">
                <thead>
                    <tr>
                        ...
                        <th data-mdb-sort="true" class="th-sm"><strong>العنوان الرئيسي</strong></th>
                        <th data-mdb-sort="true" class="th-sm"><strong>العنوان الفرعي</strong></th>
                        <th data-mdb-sort="true" class="th-sm"><strong>الرابط</strong></th>
                ...
                <tbody>
                    @foreach ($sliders as $slider)
                        <tr>
                            ...
                            <td>
                                <div class="lightbox">
                                    <img src="{{ $slider->photo_table }}" data-mdb-img="{{ $slider->photo_table }}"
                                        width="30" height="30">
                                </div>
                            </td>
                            <td>{{ $slider->title }}</td>
                            <td>{{ $slider->sub_title }}</td>
                            <td><a target="_blank" href="{{ $slider->link }}"><strong>URL</strong></a></td>
                            <td class="switch">
                                <label>
                                    نشط
                                    <input wire:click="changeStatus({{ $slider->id }})" type="checkbox"
                            ...
                            <td>
                                <div class="d-flex justify-content-center">
                                    <a type="button" class="text-danger fa-lg me-2 ms-2"
                                        wire:click='delete({{ $slider->id }})' title="Delete">
                                        <i class="fas fa-trash-can"></i>
                                    </a>

                                    <a type="button" class="text-dark fa-lg me-2 ms-2 set-button-update"
                                        data-mdb-toggle="modal" data-mdb-target="#create-new-slider-modal"
                                        href="#create-new-slider-modal" title="EditSlider"
        ...
        <div class="d-flex justify-content-between">
            ...
            <nav aria-label="...">
                <ul class="pagination pagination-circle">
                    {{ $sliders->withQueryString()->onEachSide(0)->links() }}
                </ul>
            </nav>
    ...
    <div class="modal top fade" id="create-new-slider-modal" tabindex="-1" data-mdb-backdrop="static"
        ...
        <div class="modal-dialog modal-lg cascading-modal" style="margin-top: 5%">
            <div class="modal-content">
                <div class="modal-c-tabs">
                    ...
                    <!-- Tabs navs -->
                    <ul class="nav md-tabs nav-tabs" id="create-new-slider" role="tablist"
                        style="background-color: #303030;">
                        <li class="nav-item" role="presentation">
                            <a data-mdb-tab-init class="nav-link active" id="create-new-slider-tab-1"
                                href="#create-new-slider-tabs-1" role="tab"
                                aria-controls="create-new-slider-tabs-1" aria-selected="true">
                    ...
                    <div class="tab-content" id="ex1-content">
                        ...
                        <div class="tab-pane fade show active" id="create-new-slider-tabs-1" role="tabpanel"
                            aria-labelledby="create-new-slider-tab-1">

                            <div class="modal-body">
                                <div class="row mb-3">

                                    <div class="col-md-6">
                                        <x-text-input label="العنوان الرئيسي" name="title" model="slider">
                                        </x-text-input>
                                    </div>

                                    <div class="col-md-6">
                                        <x-text-input label="العنوان الفرعي" name="sub_title" model="slider">
                                        </x-text-input>
                                    </div>
                                ...
                                <div class="row mb-3">
                                    <div class="col-md-6">
                                        <x-file-input label="صورة السلايدر" model="slider"
                                            name="photo"></x-file-input>
                                    </div>

                                    <div class="col-md-6">
                                        <x-link-input label="رابط" model="slider" name="link"></x-link-input>
                                    </div>
                                </div>

                                <div class="row">
                                    <div class="col-md-12">
                                        <x-textarea label="وصف السلايدر" name="description"
                                            model="slider"></x-textarea>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="modal-footer">
                                ...
                                <button type="button" class="btn text-white blue-color create-button"
                                    wire:click='addSlider()'>حفظ</button>

                                <button type="button" class="btn text-white blue-color update-button"
                                    wire:click='updateSlider()'>تحديث</button>
    ...
    <script>
        $(document).ready(function() {
            ...
            Livewire.on("process-has-been-done", function() {
                ...
                $("#create-new-slider-modal").modal('hide');
                $(".create-button").show();
                $(".update-button").hide();
            });

            Livewire.on("create-new-slider-errors", function(errors) {
                $(".reset-validation").text("");
                for (let key in errors[0]) {
                    if (errors[0].hasOwnProperty(key)) {
                        $("." + key + "-slider-validation").text(errors[0][key]);
                    }
                }
            });

            Livewire.on("set-slider-status", function(data) {
                const singleSelect = document.querySelector("#add-slider-status");
